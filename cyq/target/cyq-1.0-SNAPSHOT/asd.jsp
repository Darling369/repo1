...
<div class="modal" id="modal">
    ...
    <div class="fu" >
        ...
        <form action="/demo1/newuserServlet" method="post" align="center" >
            <div class="yhm">用户名：
            ...
            <div class="nicheng">昵称：&nbsp&nbsp&nbsp
                <input type="name" placeholder="请输入密码" name="name"required="required" id="c" ><br>
            </div>
            <div class="email">邮箱：&nbsp&nbsp&nbsp
                <input type="email" placeholder="请输入密码" name="email"required="required" id="d" ><br>
            </div>
